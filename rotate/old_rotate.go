...
// defaultFile                         = "./rotating"
// defaultName                         = "rotating"
// defaultExt                          = ".log"
// defaultFolder                       = "."
// defaultModePerm         os.FileMode = 0o644
...
func (s *SizeRotateFile) WriteString(str string) (n int, err error) {
	return s.Write(lib.ToBytes(str))
}
